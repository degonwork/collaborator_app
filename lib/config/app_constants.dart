class AppConstants {
  static const String baseUrlGHTK = 'https://services.giaohangtietkiem.vn';
  static const String transportFeeGHTK = '/services/shipment/fee';
  static const String statusOrder = '/services/shipment/v2/';

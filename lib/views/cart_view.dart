...
class CartView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.find<CartController>().readAllCartIsNotExistedFromDB();
    return Scaffold(
      appBar: AppBar(
        title: Center(
          child: Text(
      ...
      body: GetBuilder<CartController>(
        builder: (cartController) => cartController.isLoading
            ...
            : (cartController.carts == null || cartController.carts!.isEmpty)
                ? Center(
                    child: Column(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                Get.toNamed(Routes.getSelectTransportPage());
                              },
                              child: Container(
                                ...
                                child: Text(
                                  AppLocalizations.of(context)!.chekoutButton,
                                  style: const TextStyle(
                                    fontSize: 18,
                                    color: Colors.white,
                                  ),
